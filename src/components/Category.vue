<script setup lang='ts'>
  ...
  watch(currentCategoryId,async () => {
    const categoryGoodsInfoRes = await post<CurrentCategoryGoodsInfo>('GetCurrentList',{id: unref(currentCategoryId)[0  ], page: 1 ,size: 48})
...
<template>
  <div class="container">
    ...
    <a-menu @update:selected-keys="changeCategory" v-model:selected-keys="currentCategoryId" :disabled="categoryInfoLoading" class="menu">
